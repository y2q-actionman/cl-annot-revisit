...
(test test-@optional
  (is (equal (macroexpand-1 '(cl-annot-revisit:optional some-form slot1))
             ''(slot1 :initform some-form :initarg :slot1)))
  (is (equal (macroexpand '(cl-annot-revisit:optional #1=(+ foo bar) (slot2)))
             ''(slot2 :initform #1# :initarg :slot2)))
  (is (equal (macroexpand '(cl-annot-revisit:optional this-is-ignored
