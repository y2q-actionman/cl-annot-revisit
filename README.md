...
My main motivation implementing it again is to split its concept into two parts:
...
- Fixing many bugs of cl-annot. (TODO: make a link)
- Showing the funny *infinite* annotation I found. See `#@` syntax below.
